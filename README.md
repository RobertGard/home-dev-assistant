...
- **Автоматизация инженерных задач** — постановка через Telegram, исполнение в изолированных worker-ах
- **Self-hosted** — никаких внешних сервисов, все данные под вашим контролем
- **Горизонтальное масштабирование** — любое количество worker-ов под разные проекты
- **Интерактивный режим** — worker может запросить уточнение, оператор отвечает через Telegram
- **AI Agent** — авто-генератор анализирует историю и предлагает следующие задачи
