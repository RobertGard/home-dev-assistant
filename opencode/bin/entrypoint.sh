...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/home/agent/.npm-global/bin:/home/agent/.opencode/bin:/home/agent/.local/bin:/home/agent/.bun/bin:${PATH:-}"
